    ...
    if _is_chint_customer(customer):
        return {
            ...
            "key_analysis": [
                {
                    "audience": "盘厂客户经理",
                    "title": "把正泰按“竞合型盘厂KA”分层经营",
                    "analysis": "正泰同时是低压元件/智能配电竞品、成套/OEM控制柜节点、终端项目参与方和数字能源方案方。客户部最关键的判断不是“能不能合作”，而是每个项目里正泰到底处在采购、竞品、盘厂、终端方案还是生态伙伴哪个位置。",
                    "what_to_do": "建立正泰本体、正泰集团、正泰电气、正泰物联、项目公司和共同终端客户的分层台账；用CRM、授权系统、采购额、项目BOM、赢丢单和柜体照片核验真实边界。",
                    "risk_or_watch": "最大风险是把正泰本体当普通授权盘厂，或把所有正泰相关项目都按纯竞品放弃，导致可进入的业主指定、设计院规格、EPC技术协议和服务机会被遗漏。",
                    "source_ids": ["S1", "S20", "S21", "S54", "SE8"],
                },
                {
                    "audience": "销售",
                    "title": "销售动作要前移到规格和BOM",
                    "analysis": "正泰强在低压产品、渠道、分销现货、成套能力和终端案例；如果施耐德只在采购询价阶段出现，多数会被拉入价格、交期和国产替代比较。真正的机会在业主/设计院/EPC前置规格、关键负载、智能配电、FAT/SAT和服务闭环。",
                    "what_to_do": "每个机会先拿到项目角色、业主、设计院、EPC、盘厂/OEM、BOM、单线图、通信点表、技术协议、FAT/SAT节点和历史故障记录，再判断施耐德能进入的回路、柜型、软件、服务或备件包。",
                    "risk_or_watch": "需要避免在普通低压标准品上硬碰价格；优先选择数据中心、通信、电网、新能源、油气采油采气、机场/轨交、工业OEM等对可靠性、认证、数字化和服务要求更高的项目。",
                    "source_ids": ["S21", "S25", "S37", "S38", "S51", "SE1", "SE2", "SE6"],
                },
                {
                    "audience": "战略部门",
                    "title": "正泰是国产低压龙头上攻方案市场的长期样本",
                    "analysis": "正泰已从低压元件竞争扩展到智能配电、成套系统、绿色能源、数字平台、海外本地化和行业项目案例。它代表国产品牌从价格/渠道优势向方案化、平台化和国际化上攻，对施耐德盘厂生态和终端业主标准都有长期影响。",
                    "what_to_do": "把正泰作为持续竞争情报样本，跟踪其高端ACB、数据中心、智能配电、泰无界/正泰物联、海外认证、北美数据中心订单和共同终端客户案例，并沉淀施耐德盘厂KA价值包。",
                    "risk_or_watch": "战略风险不只是低价替代，而是正泰通过渠道、终端案例、数字平台和国产替代叙事影响业主品牌库、设计院标准和EPC技术协议；施耐德需要用可靠架构、软件工具、服务SLA和生命周期TCO形成护城河。",
                    "source_ids": ["S3", "S34", "S45", "S46", "S47", "S52", "S53", "SE2"],
                },
            ],
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "看点在主体关系边界：正泰同时具有上市公司本体、集团生态、正泰电气/物联和项目公司等多层身份，盘厂KA经营口径取决于主体拆分是否清楚。",
                    "sales_focus": "看点在项目角色识别：同一个正泰名称在项目中可能是自有品牌竞品、盘厂/OEM节点、终端项目参与方或数字能源方案方。",
                    "strategy_focus": "看点在竞争定位：正泰代表国产低压龙头向成套、智能配电、能源平台和海外本地化扩张，是盘厂生态中的结构性竞品样本。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在能力谱系：正泰能力已覆盖元件、成套柜、控制柜、智能配电和行业方案，不再只是单一低压产品竞品。",
                    "sales_focus": "看点在项目场景：数据中心、通信、电网、新能源、油气采油采气、机场/轨交、工业OEM等场景会放大柜型、点表、FAT/SAT和服务相关需求。",
                    "strategy_focus": "看点在竞争层级变化：正泰从产品竞争升级到方案竞争，竞争焦点从元器件单价延伸到架构、软件、认证、服务和生命周期TCO。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在合作边界：公开资料未证实正泰电器本体为施耐德授权盘厂，真实关系更依赖CRM、授权、采购额、BOM和赢丢单等内部证据。",
                    "sales_focus": "看点在BOM控制权：品牌指定方、可进入回路、自有品牌替代点、盘厂/业主窗口共同决定项目中的可参与空间。",
                    "strategy_focus": "看点在供应链能力：正泰具备强分销、采购云、前置仓和关键材料供应链，常规低压场景的交付和价格韧性较强。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在共同终端客户重叠：华为、中国移动、维谛、南网、中石油、中铁、机场等案例显示正泰与施耐德终端客户池存在交集。",
                    "sales_focus": "看点在项目链条：公开案例背后包含业主、设计院、EPC、柜厂/OEM、系统集成商和现场服务等多个影响节点。",
                    "strategy_focus": "看点在竞争外溢：竞争不只发生在盘厂采购端，也会延伸到终端业主标准、行业样板、品牌库和国产替代叙事。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在通路分化：正泰销售市场同时包含分销现货、盘厂BOM、行业KA和海外项目，不同通路的竞争逻辑差异很大。",
                    "sales_focus": "看点在进入时点：强渠道项目中，询价阶段往往只剩价格和交期比较，设计院/业主/EPC规范阶段的信息含金量更高。",
                    "strategy_focus": "看点在市场压力：正泰渠道下沉和海外本地化会压缩中低端市场空间，高端行业、数字服务和国际规范成为差异化区域。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在影响链宽度：正泰项目受集团/上市公司战略、产品线、质量认证、采购、区域/海外团队及外部项目方共同影响。",
                    "sales_focus": "看点在非采购影响方：技术协议、品牌库、柜型、通信点表、验收资料和售后责任往往由采购以外的角色影响。",
                    "strategy_focus": "看点在组织升级：正泰组织能力正从渠道型向行业解决方案型升级，标准制定、行业销售和数字平台组织值得关注。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在需求方向：正泰战略需求集中在智能配电、能碳管理、关键负载和海外本地化，体现其从产品公司向能源平台延展。",
                    "sales_focus": "看点在高价值话题：智能配电、能源管理、关键负载运维、海外认证和服务SLA比普通低压标准品更能体现项目价值。",
                    "strategy_focus": "看点在长期对标：正泰从低压龙头向数字能源与绿色能源平台扩张，会与EcoStruxure、能碳管理和数据中心业务形成长期对标。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在机会类型：机会窗口不在普通元件销售，而在规格、BOM、服务、关键项目、关键回路、授权柜型和运维结果证明。",
                    "sales_focus": "看点在证据颗粒度：BOM、单线图、点表、柜型照片、技术协议、FAT/SAT节点和历史故障记录决定机会是否能转化。",
                    "strategy_focus": "看点在差异化资产：可信架构、软件工具、服务闭环和高端项目证据，是施耐德盘厂KA打法中可沉淀的能力资产。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在风险结构：边界混淆、替代、价格、授权误判、信用和交付风险共同构成正泰盘厂KA经营的不确定性。",
                    "sales_focus": "看点在机会风险信号：自有品牌是否进入、BOM由谁控制、是否业主指定、是否存在服务或认证差异点，会影响赢率判断。",
                    "strategy_focus": "看点在组合型风险：正泰同时具备国产替代、渠道下沉和方案化上攻特征，高端ACB、数据中心、海外和智能配电突破值得持续观察。",
            ...
            "actions": [
                {
                    "priority": "P1",
                    "action": "先做主体边界和项目角色分层",
                    "owner": "盘厂客户经理/渠道授权/商务",
                    "detail": "承接“主体关系边界、采购边界、风险结构”看点，按正泰本体、集团关联主体、项目公司、盘厂/OEM节点、自有品牌竞品和终端方案方六类打标；同步拉通CRM、授权、客户编码、历史订单、报价和赢丢单，明确哪些场景可经营、哪些场景应按竞品防守。",
                    "source_ids": ["S1", "S5", "S20", "S42"],
                },
                {
                    "priority": "P1",
                    "action": "建立共同终端项目地图",
                    "owner": "销售/行业KA/竞争情报",
                    "detail": "承接“项目角色识别、共同终端客户重叠、项目链条”看点，围绕华为、维谛、中国移动、南网、中石油长庆油田、中铁、机场、数据中心和新能源项目，梳理业主、设计院、EPC、柜厂/OEM、系统集成商、正泰角色和施耐德历史关系。",
                    "source_ids": ["S21", "S22", "S25", "S37", "S38", "S51", "S54"],
                },
                {
                    "priority": "P1",
                    "action": "抢占规格和BOM影响节点",
                    "owner": "销售/技术销售/设计院团队",
                    "detail": "承接“BOM控制权、进入时点、非采购影响方、证据颗粒度”看点，把动作前移到业主品牌库、设计院上图、EPC技术协议、盘厂标准BOM、单线图、通信点表、柜型照片、FAT/SAT和服务验收资料。",
                    "source_ids": ["S31", "S37", "S38", "SE6", "SE8"],
                },
                {
                    "priority": "P2",
                    "action": "重做高价值场景解决方案包",
                    "owner": "解决方案/服务/数字化团队",
                    "detail": "承接“高价值话题、机会类型、差异化资产”看点，面向数据中心、通信、电网、新能源、油气采油采气、机场/轨交和工业OEM，组合关键负载可靠性、智能配电、EcoStruxure、Power Build、Power Commission、备件SLA、FAT/SAT和生命周期TCO。",
                    "source_ids": ["S34", "S45", "SE1", "SE2", "SE6", "SE8"],
                },
                {
                    "priority": "P2",
                    "action": "建立正泰竞争监测与复盘机制",
                    "owner": "战略部门/竞争情报/销售运营",
                    "detail": "承接“竞争定位、竞争层级变化、市场压力、组合型风险”看点，持续监测正泰高端ACB、智能配电、泰无界/正泰物联、海外认证、北美数据中心订单、渠道下沉和共同终端项目中的品牌库/BOM位置变化。",
                    "source_ids": ["S3", "S45", "S46", "S47", "S52", "S53"],
                },
            ],
            "watchlist": [
            ...
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "看点在主体口径：工商主体、官网历史沿革、关联公司和施耐德授权证书主体需要分开理解，中环更接近项目型重点盘厂客户。",
                    "sales_focus": "看点在项目签约主体：项目地、业主、设计院、技术/商务负责人和Prisma E/MVnex/BlokSeT授权柜型共同决定销售线索质量。",
                    "strategy_focus": "中环代表扬中成套产业集群中的授权型项目盘厂，战略价值在区域项目复制和授权柜型规模化，而非全国品牌对抗。",
                    "source_ids": ["ZH1", "ZH15"],
                },
                {
                    "module": "02 业务能力模块",
                    ...
                    "manager_focus": "看点在产品线宽度：母线槽、高低压柜、配电箱、桥架/支吊架和箱变使中环具备项目包式交付基础。",
                    "sales_focus": "看点在成套项目细节：标准BOM、柜型授权、设计院图纸深化、FAT/SAT和现场服务是成套柜/母线槽项目的重要信息。",
                    "strategy_focus": "看点在交付链延伸：中环多品类能力说明授权、软件选型和服务可以嵌入成套交付链，而不只体现为单品采购。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在授权资产：Prisma E、MVnex、BlokSeT授权证书是中环与施耐德关系的核心公开证据。",
                    "sales_focus": "看点在授权适配：项目是否落入授权柜型、同一BOM里是否出现竞品、报价和交期由谁控制，是采购模块的关键信息。",
                    "strategy_focus": "看点在授权质量：授权合作本身是盘厂生态资产，实际价值取决于采购数据、项目落地和竞品共存情况。",
                    "source_ids": ["ZH17"],
                },
                {
                    "module": "04 客户资源模块",
                    ...
                    "manager_focus": "看点在行业覆盖：电力石化、交通、公共建筑、电子厂房、水利等项目线索体现中环客户资源的行业分散性。",
                    "sales_focus": "看点在头部项目链：山东裕龙石化、常州新东化工、中车宝鸡、中国电建等线索背后包含业主、EPC、设计院和BOM信息。",
                    "strategy_focus": "看点在项目型客户结构：中环客户资源不是单一大客户，而是多行业项目样板和区域复制线索。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在市场通路：区域项目、央国企总包、化工/环保、公共建筑和轨交等通路并存，说明中环不是单一区域小客户。",
                    "sales_focus": "看点在招投标阶段：设计院、总包品牌库、询价节点和交期压力共同构成销售市场模块的关键判断信息。",
                    "strategy_focus": "看点在区域盘厂外溢：跨省项目显示区域盘厂也能进入化工、轨交、公共建筑等关键行业。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在关键人不完整：公开联系人只是入口信息，采购、技术、生产、销售和项目授权链仍属于缺口。",
                    "sales_focus": "看点在影响事项：技术协议、图纸深化、品牌替换、生产排期、质检验收和售后责任对应不同联系人。",
                    "strategy_focus": "看点在信息透明度：关键人缺失本身是信息风险，内部交易、授权培训和项目协同数据会影响判断质量。",
                    "source_ids": ["ZH1", "ZH18"],
                },
                {
                    "module": "07 发展战略与需求模块",
                    ...
                    "manager_focus": "看点在资质背书：质量、环境、职业健康、售后服务、碳足迹和能源管理认证让中环具备更高规范项目的基础。",
                    "sales_focus": "看点在需求关联：智能配电、能效、EcoFit改造、数字化运维和质量认证材料与其资质体系存在自然关联。",
                    "strategy_focus": "看点在项目等级提升：完善资质体系使中环有机会承接更高规范项目，数字化和低碳能力是重要延展方向。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在痛点类型：多产品线标准化、授权范围核验、跨行业技术规范、交付质量和关键人不透明是主要痛点。",
                    "sales_focus": "看点在机会证据：项目清单、图纸、BOM、竞品报价、授权证书需求、交付周期和历史售后问题决定机会成熟度。",
                    "strategy_focus": "看点在可复制能力：标准BOM、设计院规格、培训、FAT/SAT和服务闭环构成授权盘厂复制包的核心元素。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在商务透明度：非上市企业财务、现金流、客户集中度和付款信用不可见，账期和验收周期是风险核心。",
                    "sales_focus": "看点在合同风险：付款节点、业主/总包付款路径、项目公司资质、质保责任和违约条款决定项目风险画像。",
                    "strategy_focus": "看点在风险来源：非上市项目盘厂的风险主要来自信息不透明和项目现金流，内部交易与外部招采证据同样重要。",
            ...
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "看点在主体与基地拆分：上市公司、盛虹炼化、斯尔邦、虹港、港储、EPC/盘厂路径共同构成KA关系图。",
                    "sales_focus": "看点在机会落点：基地、装置、公辅系统和联系人职能决定线索属于采购、设备、电仪、安环、生产、EPC还是盘厂链路。",
                    "strategy_focus": "东方盛虹是炼化新材料基地型KA，战略价值在连续生产、能效降本、高端材料扩产和盘厂生态牵引。",
                    "source_ids": ["SH1", "SH2"],
                },
                {
                    "module": "02 业务能力模块",
                    ...
                    "manager_focus": "看点在基地业务结构：炼化一体化、MTO/PDH、EVA/POE、聚酯化纤、公辅变电所和储运码头对应不同电气需求。",
                    "sales_focus": "看点在电气机会类型：中低压柜、MCC、智能仪表、电能质量、UPS/关键负载、备件和检修窗口与连续生产强相关。",
                    "strategy_focus": "看点在价值来源：基地规模和连续生产特征使可靠供电、装置开车、能效和资产健康比单件价格更关键。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在采购信息缺口：业主品牌库、项目BOM、EPC规范、合格供应商、历史装机、采购额和账期仍是关键缺失项。",
                    "sales_focus": "看点在采购入口：检修技改、备件框架、EPC技术协议和盘厂BOM体现电气侧可进入的采购路径。",
                    "strategy_focus": "看点在供应链偏好：采购系统智能化和大宗原料长约说明客户重视供应链确定性、交付保障和生命周期价值。",
                    "source_ids": ["SH1", "SH7"],
                },
                {
                    "module": "04 客户资源模块",
                    ...
                    "manager_focus": "看点在下游质量牵引：EVA、POE、丙烯腈、聚酯等下游客户要求会反向放大基地可靠性和能效需求。",
                    "sales_focus": "看点在行业客户倒逼：光伏胶膜、碳纤维、高端材料客户对质量一致性敏感，对智能配电、设备健康和停机风险形成需求背景。",
                    "strategy_focus": "看点在样板价值：下游高端材料客户牵引会放大基地稳定性需求，流程工业高可靠供配电具备样板意义。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在价值敏感性：周期压力下客户关注价格、交付和现金流，但TCO和风险减损仍是高价值项目的解释框架。",
                    "sales_focus": "看点在采购关注点：停机损失、能耗收益、备件可得性、开车保障和服务响应会影响客户对价格的判断。",
                    "strategy_focus": "看点在周期窗口：石化周期下行压低CAPEX，盈利修复期则更可能出现能效、可靠性和技改需求。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在多层决策：采购、设备、电仪、安环、生产运行、EPC/设计院和盘厂承包商共同影响电气项目。",
                    "sales_focus": "看点在技术影响方：电仪/设备、EPC技术澄清、点表、单线图、品牌库和验收标准比单点采购信息更重要。",
                    "strategy_focus": "看点在组织复杂度：盛虹决策链长且专业，行业解决方案、服务和盘厂协同是理解项目链路的关键。",
                    "source_ids": ["SH1", "KB2"],
                },
                {
                    "module": "07 发展战略与需求模块",
                    ...
                    "manager_focus": "看点在数智低碳主线：流程工业大模型、智能工厂、AI、能效和绿色材料共同指向电气数据和资产健康需求。",
                    "sales_focus": "看点在技术话题：PME/PO、网关、预测维护、电气数据接入、能耗优化和检修数字化与客户战略高度相关。",
                    "strategy_focus": "看点在平台匹配：客户数字化和高端材料战略与EcoStruxure存在匹配空间，流程工业电气数据底座具备战略价值。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在机会窗口：降本增效、开车保障、检修窗口、备件SLA、停机风险和付款安全共同影响机会优先级。",
                    "sales_focus": "看点在现场证据：装机品牌图谱、故障/检修记录、备件清单、检修窗口和EPC技术协议决定机会是否具体。",
                    "strategy_focus": "看点在优势组合：可靠性、能效和服务闭环可以与停机风险、能源收益、高端定位形成对应关系。",
                ...
                },
                {
                    ...
                    "manager_focus": "看点在风险约束：高资产负债率、项目账期、安全环保和连续生产风险共同影响KA经营边界。",
                    "sales_focus": "看点在合同边界：项目主体、付款路径、验收节点、EPC责任边界和质保/售后条款是销售侧风险信号。",
                    "strategy_focus": "看点在窗口与约束并存：盈利修复带来项目窗口，但财务杠杆和安全环保约束仍高。",
