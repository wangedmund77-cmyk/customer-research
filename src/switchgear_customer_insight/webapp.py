            ...
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "把正泰定为“竞合型盘厂KA”，要求客户经理按上市公司本体、正泰集团、正泰电气、正泰物联和项目公司分主体建档，避免把竞品、客户和生态伙伴混成一个口径。",
                    "sales_focus": "拜访前先确认本次项目中正泰的角色：自有品牌竞品、盘厂/OEM节点、终端项目参与方，还是数字能源方案方；不同角色决定是否报价、是否前置业主/设计院。",
                    "strategy_focus": "正泰代表国产低压龙头向成套、智能配电、能源平台和海外本地化扩张，是施耐德在中国盘厂生态中必须持续跟踪的结构性竞品。",
                ...
                },
                {
                    ...
                    "manager_focus": "把正泰能力拆成元件、成套柜、控制柜、智能配电、行业方案五类，分配不同销售/技术资源，不用单一“低压竞品”标签处理所有机会。",
                    "sales_focus": "优先抓数据中心、通信、电网、新能源、油气采油采气、机场/轨交、工业OEM等场景中的关键回路、柜型、点表、FAT/SAT和服务机会。",
                    "strategy_focus": "正泰从产品竞争升级为方案竞争，说明施耐德需要用架构、软件、服务、认证和生命周期TCO形成差异，而不是只对比元器件。",
                ...
                },
                {
                    ...
                    "manager_focus": "要求团队用CRM、授权系统、采购额、项目BOM、柜体照片和赢丢单核验合作边界；未经核验不要把正泰本体按普通授权盘厂经营。",
                    "sales_focus": "销售动作应落到项目BOM口径：谁指定品牌、哪些回路可进施耐德、哪些元件被正泰自有品牌替代、是否有盘厂/业主指定窗口。",
                    "strategy_focus": "正泰有强分销、采购云、前置仓和关键材料供应链；常规低压交付优势强，施耐德应在高可靠、授权柜型、数字化调试和服务SLA上防守。",
                ...
                },
                {
                    ...
                    "manager_focus": "把正泰公开案例转成共同终端客户地图，标注施耐德已有关系、正泰优势行业、可前置品牌库和需要高层覆盖的KA。",
                    "sales_focus": "围绕华为/维谛/中国移动/南网/中石油/中铁/机场等案例反查项目链：业主、设计院、EPC、柜厂、系统集成商和现场服务负责人。",
                    "strategy_focus": "共同客户高度重叠，说明竞争不只发生在盘厂采购端，而会延伸到终端业主标准、行业样板和国产替代叙事。",
                ...
                },
                {
                    ...
                    "manager_focus": "按分销现货、盘厂BOM、行业KA、海外项目四类设不同经营目标和考核，不要求销售在所有正泰相关场景硬碰价格。",
                    "sales_focus": "遇到正泰强渠道项目时，销售要尽早进入设计院/业主/EPC规范；询价阶段才进入，多数只能被动比价和比交期。",
                    "strategy_focus": "正泰渠道下沉与海外本地化会压缩施耐德中低端市场空间，战略上应强化高端行业、数字服务和国际规范护城河。",
                ...
                },
                {
                    ...
                    "manager_focus": "建立“内部关键人+外部影响方”双链路：正泰高层/产品/质量/采购/区域团队，以及业主、设计院、EPC、盘厂和集成商。",
                    "sales_focus": "不要只找采购，优先找能影响技术协议、品牌库、柜型、通信点表、验收资料和售后责任的人。",
                    "strategy_focus": "正泰的组织能力正在从渠道型向行业解决方案型升级，施耐德需要监测其标准制定、行业销售和数字平台组织建设。",
                ...
                },
                {
                    ...
                    "manager_focus": "把正泰战略需求归为智能配电、能碳管理、关键负载、海外本地化四类，决定施耐德是否投入专家、样板、服务和战略客户资源。",
                    "sales_focus": "销售可用智能配电、能源管理、关键负载运维、海外认证和服务SLA打开话题，少在普通低压标准品上纠缠。",
                    "strategy_focus": "正泰正在从低压龙头向数字能源与绿色能源平台公司扩张，会与施耐德EcoStruxure、能碳管理和数据中心业务形成长期对标。",
                ...
                },
                {
                    ...
                    "manager_focus": "把机会池从“卖元件”改成“锁规格、锁BOM、锁服务”：重点投入关键项目、关键回路、授权柜型、调试报告和运维服务。",
                    "sales_focus": "下一步动作是拿到BOM、单线图、点表、柜型照片、技术协议、FAT/SAT节点和历史故障/售后记录，形成可报价的施耐德价值包。",
                    "strategy_focus": "施耐德的优势在可信架构、软件工具、服务闭环和高端项目证据；应持续把这些能力产品化为盘厂KA打法。",
                ...
                },
                {
                    ...
                    "manager_focus": "把风险打标为边界风险、替代风险、价格风险、授权误判风险和信用/交付风险；没有内部数据前不要承诺大客户经营结论。",
                    "sales_focus": "每个机会必须回答：正泰是否自有品牌进入、谁控制BOM、是否业主指定、施耐德是否有服务或认证不可替代点。",
                    "strategy_focus": "正泰是国产替代、渠道下沉和方案化上攻的组合型风险；战略部门需持续监控其高端ACB、数据中心、海外和智能配电突破。",
            ...
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "按项目型重点盘厂客户建档，客户部经理要核验工商主体、官网主体、关联公司和施耐德授权证书主体，避免把历史沿革与交易主体混用。",
                    "sales_focus": "拜访前确认本次项目由哪个主体签约、谁负责技术/商务、是否使用Prisma E/MVnex/BlokSeT授权柜型，并把项目地、业主和设计院回填。",
                ...
                },
                {
                    ...
                    "manager_focus": "按母线槽、高低压柜、配电箱、桥架/支吊架、箱变建立产品线机会池，分配低压、中压、服务、能效资源。",
                    "sales_focus": "优先锁定成套柜/母线槽项目中的标准BOM、柜型授权、设计院图纸深化、FAT/SAT和现场服务节点。",
                    "strategy_focus": "中环多品类能力说明施耐德可从单品销售转为项目包经营，把授权、软件选型和服务嵌入成套交付链。",
                ...
                },
                {
                    ...
                    "manager_focus": "把施耐德授权证书、有效期、授权范围、采购额、主采SKU、竞品西门子比例作为客户部必补台账。",
                    "sales_focus": "销售推进时先查授权柜型能否覆盖本项目，再确认竞品是否进入同一BOM、报价和交期是否由中环采购控制。",
                    "strategy_focus": "授权合作是施耐德防守盘厂生态的关键资产，但需要用数据证明实际采购与项目落地，防止授权牌照空转。",
                    "source_ids": ["ZH17"],
                },
                {
                    "module": "04 客户资源模块",
                    ...
                    "manager_focus": "把公开项目按电力石化、交通、公共建筑、电子厂房、水利等行业建机会池，并标注施耐德已有终端关系。",
                    "sales_focus": "从山东裕龙石化、常州新东化工、中车宝鸡、中国电建等线索反查业主、EPC、设计院和盘厂BOM。",
                    "strategy_focus": "中环客户资源偏项目型、多行业分散，适合用行业样板复制，而不是只经营单点客户关系。",
                ...
                },
                {
                    ...
                    "manager_focus": "把中环市场覆盖拆成区域项目、央国企总包、化工/环保、公共建筑和轨交等通路，匹配不同销售节奏。",
                    "sales_focus": "招投标项目前置设计院和总包品牌库，询价后再进入会容易只剩价格/交期竞争。",
                    "strategy_focus": "中环跨省项目说明区域盘厂也能进入关键行业，战略部门应监控授权盘厂在化工、轨交、公共建筑的覆盖密度。",
                ...
                },
                {
                    ...
                    "manager_focus": "把已公开联系人作为入口，不等同于采购/技术决策人；客户部要补齐采购、技术、生产、销售和项目授权链。",
                    "sales_focus": "拜访目标应覆盖技术协议、图纸深化、品牌替换、生产排期、质检验收和售后责任负责人。",
                    "strategy_focus": "关键人缺失是信息风险，说明战略判断需依赖内部交易、授权培训和项目协同数据补强。",
                    "source_ids": ["ZH1", "ZH18"],
                },
                {
                    "module": "07 发展战略与需求模块",
                    ...
                    "manager_focus": "把认证、质量、售后、碳足迹、能源管理作为经营抓手，推动中环把授权柜型与绿色/服务能力绑定。",
                    "sales_focus": "用智能配电、能效、EcoFit改造、数字化运维和质量认证材料切入技术澄清。",
                    "strategy_focus": "中环资质体系完善，适合承接更高规范项目；施耐德可用数字化和低碳能力提升授权盘厂项目等级。",
                ...
                },
                {
                    ...
                    "manager_focus": "机会管理重点是标准化、授权核验、跨行业技术支持和交付质量，客户部应建立项目复盘与培训机制。",
                    "sales_focus": "下一步拿到项目清单、图纸、BOM、竞品报价、授权证书需求、交付周期和历史售后问题，转成可执行报价包。",
                    "strategy_focus": "施耐德打法应沉淀为授权盘厂复制包：标准BOM、设计院规格、培训、FAT/SAT、服务闭环。",
                ...
                },
                {
                    ...
                    "manager_focus": "把财务不可见、账期、项目主体、验收周期和售后边界列为准入打标，避免授权客户经营中过度授信。",
                    "sales_focus": "报价前确认付款节点、业主/总包付款路径、项目公司资质、质保责任和违约条款。",
                    "strategy_focus": "非上市项目盘厂的风险主要来自信息不透明和项目现金流，应以内部交易与外部招采证据联合评级。",
            ...
            "module_takeaways": [
                {
                    ...
                    "manager_focus": "按上市公司、盛虹炼化、斯尔邦、虹港、港储、EPC/盘厂路径拆分KA档案，客户部经理重点管清主体、基地、项目包和付款路径。",
                    "sales_focus": "拜访前确认机会落在哪个基地/装置/公辅系统，联系人属于采购、设备、电仪、安环、生产、EPC还是盘厂。",
                ...
                },
                {
                    ...
                    "manager_focus": "把机会按炼化一体化、MTO/PDH、EVA/POE、聚酯化纤、公辅变电所、储运码头分包，配置行业销售、服务和技术专家。",
                    "sales_focus": "重点寻找中低压柜、MCC、智能仪表、电能质量、UPS/关键负载、备件和检修窗口机会。",
                    "strategy_focus": "基地规模和连续生产特征说明施耐德价值不在单件价格，而在可靠供电、装置开车、能效和资产健康。",
                ...
                },
                {
                    ...
                    "manager_focus": "客户部需要补齐业主品牌库、项目BOM、EPC规范、合格供应商、历史装机、采购额和账期。",
                    "sales_focus": "销售从检修技改、备件框架、EPC技术协议和盘厂BOM切入，优先找能影响品牌库和装机替换的节点。",
                    "strategy_focus": "采购系统智能化和大宗原料长约说明客户重视供应链确定性；施耐德应突出服务SLA、交付保障和生命周期价值。",
                    "source_ids": ["SH1", "SH7"],
                },
                {
                    "module": "04 客户资源模块",
                    ...
                    "manager_focus": "把EVA、POE、丙烯腈、聚酯等下游客户质量要求转成电气可靠性和能效项目理由。",
                    "sales_focus": "围绕光伏胶膜、碳纤维、高端材料客户倒逼的质量一致性，切入智能配电、设备健康和停机风险话题。",
                    "strategy_focus": "下游高端材料客户牵引会放大基地稳定性需求，战略上适合打造流程工业高可靠供配电样板。",
                ...
                },
                {
                    ...
                    "manager_focus": "在周期压力下设置TCO和风险减损类目标，不只考核单次设备成交。",
                    "sales_focus": "用停机损失、能耗收益、备件可得性、开车保障和服务响应说服采购端，减少单纯价格比较。",
                    "strategy_focus": "石化周期下行会压低CAPEX，但盈利修复期更愿意投能效、可靠性和技改项目。",
                ...
                },
                {
                    ...
                    "manager_focus": "客户部要建立采购、设备、电仪、安环、生产运行、EPC/设计院、盘厂承包商的多层决策图。",
                    "sales_focus": "单点采购拜访不足，必须进入电仪/设备和EPC技术澄清，拿到点表、单线图、品牌库和验收标准。",
                    "strategy_focus": "盛虹决策链长且专业，施耐德需要行业解决方案和服务团队协同，而不是单一渠道打法。",
                    "source_ids": ["SH1", "KB2"],
                },
                {
                    "module": "07 发展战略与需求模块",
                    ...
                    "manager_focus": "把流程工业大模型、智能工厂、AI、能效和绿色材料转成智能配电/能碳/资产健康机会池。",
                    "sales_focus": "围绕PME/PO、网关、预测维护、电气数据接入、能耗优化和检修数字化组织技术交流。",
                    "strategy_focus": "客户数字化和高端材料战略与施耐德EcoStruxure匹配，适合做流程工业电气数据底座样板。",
                ...
                },
                {
                    ...
                    "manager_focus": "机会优先级应看降本增效、开车保障、检修窗口、备件SLA、停机风险和付款安全。",
                    "sales_focus": "下一步拿装机品牌图谱、故障/检修记录、备件清单、检修窗口和EPC技术协议，形成试点方案。",
                    "strategy_focus": "施耐德优势应包装成“可靠性+能效+服务闭环”组合，用实际停机风险和能源收益支撑高端定位。",
                ...
                },
                {
                    ...
                    "manager_focus": "高资产负债率、项目账期、安全环保和连续生产风险必须进入客户准入与授信评审。",
                    "sales_focus": "签约前核验项目主体、付款路径、验收节点、EPC责任边界和质保/售后条款。",
                    "strategy_focus": "盈利修复带来窗口，但财务杠杆和安全环保约束仍高，战略投入要和风险敞口同步管理。",
